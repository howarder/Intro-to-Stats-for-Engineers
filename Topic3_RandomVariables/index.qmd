...
(1) Let the random variable $X$ represent the number of times a post-op patient will ring the nurse during a 12-hour shift. A random sample of patients yielded the following model for the random variable.

|        |      |      |      |      |      |      |
|--------|------|------|------|------|------|------|
| $x$    | 0    | 1    | 2    | 3    | 4    | 5    |
| $p(x)$ | 0.08 | 0.16 | 0.32 | 0.28 | 0.12 | 0.04 |
:::
...
[$F(2)=$$P(X \leq 2)$$=p(0)+p(1)+p(2)$$=0.08+0.16+0.32=0.56$]{.fragment}
:::
...
::: fragment
$$E(X) = 0(0.08) + 1(0.16) + 2(0.32) + 3(0.28) + 4(0.12) + 5(0.04) = 2.32$$
:::

 

[During a 12-hour shift, we **expect** a post-op patient will ring the nurse 2.32 times.]{.fragment}
:::
...
::: {style="color:green;"}
1.  Let the random variable 𝑋 represent the number of times a post-op patient will ring the nurse during a 12-hour shift. A random sample of patients yielded the following model for the random variable.
...
::: fragment
$$E(X^2) = 0^2(0.08) + 1^2(0.16) + 2^2(0.32) + 3^2(0.28) + 4^2(0.12) + 5^2(0.04) = 6.88$$
:::

::: fragment
$$Var(X) = E(X^2)-(E(X))^2 = 6.88 - 2.32^2 = 1.4976$$
:::

::: fragment
$$SD(X) = \sqrt{1.4976} = 1.2238$$
:::
:::
